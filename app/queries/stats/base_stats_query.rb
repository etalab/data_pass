class Stats::BaseStatsQuery
  ...
  def filtered_requests_with_first_submit_in_range
    filtered_requests
      .joins(join_first_event('submit', 'first_submit_events'))
      .where(first_submit_events: { event_time: date_range.begin.. })
      .where(first_submit_events: { event_time: ..date_range.end })
  end
