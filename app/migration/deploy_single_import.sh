...
ssh -A watchdoge -- sudo rm -rf /var/www/datapass_reborn_$RAILS_ENV/current/app/migration/
ssh -A watchdoge -- sudo cp dumps /var/www/datapass_reborn_$RAILS_ENV/current/app/migration/
