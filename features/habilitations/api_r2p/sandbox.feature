...
Fonctionnalité: Soumission d'une demande d'habilitation API R2P
  Contexte:
    Sachant que je suis un demandeur
    Et que je me connecte

  Plan du scénario: Je soumets une demande d'habilitation valide
    Quand je veux remplir une demande pour "API R2P" via le formulaire "<Nom du formulaire>" à l'étape "Bac à sable"
