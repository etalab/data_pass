...
Fonctionnalité: Création de changelog sur les habilitations soumises
  ...
  Contexte:
    Sachant que je suis un rapporteur "Démarche Certificats de Décès Électroniques Dématérialisés (CertDc)"
    Et que je me connecte

  @DisableBullet
  Scénario: Je soumets une demande d'habilitation après avoir modifié un champ à la suite d'une demande de modification
    Quand il y a 1 demande d'habilitation "Démarche Certificats de Décès Électroniques Dématérialisés (CertDc)" en attente de modification
    ...
    Alors la page contient "Le champ Nom de famille de l'administrateur local a changé de \"Dupont Administrateur metier\" en \"Durand\""
