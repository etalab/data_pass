...
RSpec.describe AssignFranceConnectDefaults do
  describe '#call' do
    ...
    context 'when APIPFC request with FC modality and no existing FC authorization' do
      before do
