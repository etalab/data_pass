class ApplicationMailer < ActionMailer::Base
  ...
  def extract_host
    ...
    elsif params[:authorization_request_instructor_draft].present?
      build_host_from_authorization_request(params[:authorization_request_instructor_draft].request)
    end
  end
