...
Fonctionnalité: Impersonation des utilisateurs
  ...
  Contexte:
    ...
    Et qu'il existe un utilisateur "user@example.com"
  ...
  Scénario: Un administrateur peut impersonner un utilisateur
    ...
    Alors je devrais voir "Impersonner un utilisateur"
    
    Quand je remplis "Email de l'utilisateur" avec "user@example.com"
    Et que je remplis "Raison de l'impersonation" avec "Ticket de support #12345"
    Et que je clique sur "Commencer l'impersonation"
    
    Alors je devrais voir "Impersonation activée"
    Et je devrais voir "Mode impersonation activé"
    Et je devrais voir "Vous (admin@gouv.fr) êtes connecté en tant que user@example.com"
    Et je devrais être sur la page du tableau de bord
  ...
  Scénario: Un administrateur peut arrêter l'impersonation
    ...
    Alors je devrais voir "Impersonation terminée"
  ...
  Scénario: Un administrateur ne peut pas impersonner un utilisateur inexistant
    ...
    Alors je devrais voir "Utilisateur introuvable"
    Et je devrais voir "Aucun utilisateur avec l'email inexistant@example.com"
  ...
  Scénario: Un administrateur ne peut pas s'impersonner lui-même
    ...
    Et je devrais voir "Vous ne pouvez pas vous impersonner vous-même"
