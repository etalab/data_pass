...
Fonctionnalité: Accessibilité
  ...
  Scénario: Les liens d'évitement fonctionnent correctement sur la page tableau de bord
    ...
    Alors je dois voir des liens d'évitement
    Et le lien d'évitement "Tableau de bord" doit mener à l'élément "#content"
    Et le lien d'évitement "Demandes à modifier" doit mener à l'élément "#changes-requested-section"
    Et le lien d'évitement "Demandes en cours d'instruction" doit mener à l'élément "#pending-section"
    Et le lien d'évitement "Brouillons" doit mener à l'élément "#draft-section"
    Et le lien d'évitement "Mes habilitations" doit mener à l'élément "#validated-refused-section"
    Et le lien d'évitement "Menu" doit mener à l'élément "#header"
    Et le lien d'évitement "Pied de page" doit mener à l'élément "#footer"

  @demandeur
  Scénario: Les liens d'évitement fonctionnent correctement sur la page des statistiques
    Sachant que je suis un demandeur
    Et que je me connecte
    Et que je vais sur la page des stats
    Alors je dois voir des liens d'évitement
    Et le lien d'évitement "Statistiques d'utilisation" doit mener à l'élément "#content"
    Et le lien d'évitement "Menu" doit mener à l'élément "#header"
    Et le lien d'évitement "Pied de page" doit mener à l'élément "#footer"
