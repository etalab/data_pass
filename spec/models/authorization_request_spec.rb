RSpec.describe AuthorizationRequest do
  ...
  describe '#latest_authorizations_of_each_stage' do
    ...
    it { is_expected.to match_array([sandbox_authorization, production_authorization]) }
    ...
    context 'when there is a newer sandbox authorization' do
      ...
      it { is_expected.to match_array([new_sandbox_authorization, production_authorization]) }
    end
  end
