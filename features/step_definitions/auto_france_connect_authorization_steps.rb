...
Sachantque("j'ai une demande API Particulier d'éditeur certifié FC avec génération d'une nouvelle habilitation en brouillon") do
  FactoryBot.create(
    :authorization_request,
    :france_connect,
    :validated,
  ...
  @authorization_request = FactoryBot.create(
    ...
    applicant: current_user,
    organization: current_user.current_organization,
    fc_authorization_mode: 'generate_new',
    contact_technique_phone_number: '0612345678'
  )
end
