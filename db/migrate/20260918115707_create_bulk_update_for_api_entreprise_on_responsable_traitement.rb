class CreateBulkUpdateForAPIEntrepriseOnResponsableTraitement < ActiveRecord::Migration[8.1]
  ...
  def reason
    <<~REASON
      Le responsable de traitement n’est dorénavant plus demandé pour l’obtention d’une habilitation à API Entreprise. Les informations déjà renseignées sont conservées mais ne sont plus affichées ni utilisées.
