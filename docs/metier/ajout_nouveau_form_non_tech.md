...
La spécification détaillée de toutes les clés est situé [ici](../technique/nouveau_type_d_habilitation.md#configuration-du-authorizationrequestform).
...
2. Si vous voulez faire un nouveau formulaire, suivez la documentation
   [ici](../technique/nouveau_type_d_habilitation.md##42-cas-du-formulaire-sur-une-page) (peut nécessiter
   un développeur)
...
Se référer à [la documentation](../technique/nouveau_type_d_habilitation.md#3-configurer-les-formulations-via-li18n)
...
Se référer à [la documentation](../technique/nouveau_type_d_habilitation.md#5-ajout-du-test-dint%C3%A9gration-cucumber)
