RSpec.describe HubEECertDCBridge do
  ...
  before do
    ...
    allow(hubee_api_client).to receive(:create_subscription).and_return(subscription_response.with_indifferent_access)
  end

  describe '#perform' do
    it 'does not render en error' do
      expect { hubee_cert_dc_bridge }.to_not raise_error
    end
