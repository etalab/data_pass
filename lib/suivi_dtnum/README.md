...
2. Renommer la colonne "N° DataPass v1" en "N° DataPass v1"
...
6. Faire tourner le script `update_suivi_dtnum.py` avec ces credentials et le fichier de suivi pour générer un nouveau fichier à jour

## Mise à jour du fichier après initialisation

Faire tourner le script `update_suivi_dtnum.py` avec les credentials sus-cités et le dernier fichier de suivi
