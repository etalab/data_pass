...
RSpec.describe AutoGeneratedFranceConnectMailer do
  describe '#approve' do
    subject(:mail) { described_class.with(authorization:).approve }
    ...
    it 'renders the body with FC-specific content' do
  ...
  describe '#new_scopes' do
    ...
    it 'includes the linked authorization ID' do
      expect(mail.body.encoded).to include(linked_authorization.id.to_s)
    end
