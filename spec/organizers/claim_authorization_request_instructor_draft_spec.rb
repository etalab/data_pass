...
RSpec.describe ClaimAuthorizationRequestInstructorDraft, type: :organizer do
  ...
  let!(:authorization_request_instructor_draft) do
    create(:authorization_request_instructor_draft, :complete, claimed: false, data: { 'intitule' => 'Test Project' })
  end

  let(:organization) { authorization_request_instructor_draft.organization }
