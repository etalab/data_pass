...
Fonctionnalité: Titres de page des pages de sélection de formulaire
  ...
  Scénario: Le titre de la page de sélection API SFiP est Choix du type de données - API - DataPass
    ...
    Alors le titre de la page contient "Choix du type de données - API Courtier fonctionnel SFiP - DataPass"
  ...
  Scénario: Le titre de la page de sélection API Ficoba est Choix du cas d'usage - nom de l'API - DataPass
    ...
    Alors le titre de la page contient "Choix du cas d'usage - API Fichier des Comptes Bancaires et Assimilés (FICOBA) - DataPass"
  ...
  Scénario: Le titre de la page de sélection API Droits CNAM est correct
    ...
    Alors le titre de la page contient "Habilitation France Connect manquante - API de droits à l'Assurance Maladie - DataPass"
