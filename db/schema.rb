...
ActiveRecord::Schema[8.1].define(version: 2026_07_01_000000) do
  ...
  create_table "admin_changes", force: :cascade do |t|
    ...
    t.index ["authorization_request_id"], name: "index_admin_changes_on_authorization_request_id"
  end
  ...
  create_table "authorization_request_events", force: :cascade do |t|
    ...
    t.check_constraint "name::text = 'refuse'::text AND entity_type::text = 'DenialOfAuthorization'::text OR name::text = 'auto_reject'::text AND entity_type::text = 'DenialOfAuthorization'::text OR name::text = 'request_changes'::text AND entity_type::text = 'InstructorModificationRequest'::text OR name::text = 'approve'::text AND entity_type::text = 'Authorization'::text OR name::text = 'auto_approve'::text AND entity_type::text = 'Authorization'::text OR name::text = 'auto_generate'::text AND entity_type::text = 'Authorization'::text OR name::text = 'reopen'::text AND entity_type::text = 'Authorization'::text OR name::text = 'submit'::text AND entity_type::text = 'AuthorizationRequestChangelog'::text OR name::text = 'admin_update'::text AND entity_type::text = 'AuthorizationRequestChangelog'::text OR name::text = 'admin_change'::text AND entity_type::text = 'AdminChange'::text OR name::text = 'applicant_message'::text AND entity_type::text = 'Message'::text OR name::text = 'instructor_message'::text AND entity_type::text = 'Message'::text OR name::text = 'revoke'::text AND entity_type::text = 'RevocationOfAuthorization'::text OR name::text = 'transfer'::text AND entity_type::text = 'AuthorizationRequestTransfer'::text OR name::text = 'cancel_reopening'::text AND entity_type::text = 'AuthorizationRequestReopeningCancellation'::text OR name::text = 'bulk_update'::text AND entity_type::text = 'BulkAuthorizationRequestUpdate'::text OR name::text = 'claim'::text AND entity_type::text = 'InstructorDraftRequest'::text OR name::text = 'create_by_api'::text AND entity_type::text = 'AuthorizationRequestChangelog'::text OR name::text = 'update_by_api'::text AND entity_type::text = 'AuthorizationRequestChangelog'::text OR entity_type::text = 'AuthorizationRequest'::text", name: "entity_type_validation"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.check_constraint "banned_at IS NULL OR ban_reason IS NOT NULL AND ban_reason <> ''::text", name: "ban_reason_required_when_banned"
  end
  ...
  add_foreign_key "admin_changes", "authorization_requests"
