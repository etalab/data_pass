...
RSpec.describe DeliverLinkedFranceConnectRevocationNotification do
  describe '#call' do
    ...
    def create_linked_fc_authorization
      create(
        :authorization,
        :auto_generated,
    ...
    context 'when there are auto-generated linked FranceConnect authorizations' do
      let!(:linked_fc_authorization) { create_linked_fc_authorization }
      ...
      context 'with multiple linked FC authorizations' do
        let!(:another_fc_authorization) { create_linked_fc_authorization }
    ...
    context 'when the FranceConnect authorization was not auto-generated' do
      let!(:standalone_fc_authorization) do
        create(
          :authorization,
          request: authorization_request,
          applicant: authorization_request.applicant,
