...
Fonctionnalité: Soumission d'une demande d'habilitation API IMPRIM'FIP
  Contexte:
    Sachant que je suis un demandeur
    Et que je me connecte

  Scénario: Je soumets une demande d'habilitation valide à l'étape Bac à sable
    * je démarre une nouvelle demande d'habilitation "API IMPRIM’FIP" à l'étape "Bac à sable"
  ...
  Scénario: Je soumets une demande d'habilitation valide à l'étape Production
    Quand j'ai 1 demande d'habilitation "API IMPRIM’FIP" à l'étape "Bac à sable" validée
