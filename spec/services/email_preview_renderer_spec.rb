RSpec.describe EmailPreviewRenderer do
  ...
  describe '#render' do
    ...
    context 'with approval action' do
      ...
      it 'renders the approve mailer HTML template' do
      ...
      it 'linkifies URLs' do
        expect(render).to include('<a href=')
      end
    end
    ...
    context 'with refusal action' do
      ...
      it 'renders the refuse mailer HTML template' do
    ...
    context 'with request_changes action' do
      ...
      it 'renders the request_changes mailer HTML template' do
    ...
    context 'with reopening authorization request' do
      ...
      it 'renders the reopening_approve mailer HTML template' do
