class AutoGeneratedFranceConnectMailer < ApplicationMailer
  def approve
    ...
    mail(
      ...
      subject: t('.subject', authorization_request_id: @authorization.request.formatted_id)
    )
  end
  ...
  def new_scopes
    ...
    mail(
      ...
      subject: t('.subject', organization_name: @authorization_request.organization.name, authorization_request_id: @authorization_request.formatted_id),
