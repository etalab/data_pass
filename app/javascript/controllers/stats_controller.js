...
export default class extends Controller {
  ...
  static values = {
    migrationDate: { type: String, default: '2025-01-01' },
  ...
  async loadFilterOptions () {
    try {
      ...
      this.isInitializing = false
      ui.showError(this.errorElement, this.errorLoadFiltersValue || 'Impossible de charger les filtres. Veuillez réessayer.')
    }
  }
  ...
  async loadData () {
    ...
    try {
      ...
      this.timeSeriesChartInstance = dataManager.updateTimeSeriesChart(
        ...
        data.time_series, this.timeSeriesChartInstance, this.chartLabelsValue
      )
      ...
      ui.hideLoading(this.loadingElement)
      ui.showError(this.errorElement, error.message || this.errorLoadStatsValue || 'Impossible de charger les statistiques. Veuillez réessayer.')
    }
  }
