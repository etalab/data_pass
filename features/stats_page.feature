...
Fonctionnalité: Page de statistiques
  ...
  Scénario: Je visite la page de stats
    ...
    Alors la page des stats affiche le titre principal
  ...
  @javascript
  Scénario: Erreur lorsque la date de fin est antérieure à la date de début
    Quand je visite la page des stats avec les paramètres "start_date=2025-12-01&end_date=2025-01-01"
    Alors la page affiche l'erreur de plage de dates

  @javascript
  Scénario: Les boutons de plage rapide mettent à jour les dates
    Quand je vais sur la page des stats
    Et je clique sur la plage rapide "30 derniers jours"
    Alors les champs de date de la page des stats sont renseignés
